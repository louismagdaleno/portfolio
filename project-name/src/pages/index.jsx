  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> I'm Louis Magdaleno.
          </BigTitle>
          <Subtitle>I'm a full-stack web developer in Los Angeles, CA. I have experience building applications with React and Mongodb.</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:buildthatapp@gmail.com">Hi</a> or find me on other platforms:{' '}
            <a href="https://www.linkedin.com/in/louis-magdaleno/">LinkedIn</a> &{' '}
            <a href="https://github.com/louismagdaleno/">Github</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2018 by Gatsby Starter Portfolio Louis.{' '}
